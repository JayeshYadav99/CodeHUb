...
to showcase your skills & get rewarded!</p>
      ...
      <section className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <Card image={`https://media-fastly.hackerearth.com/media/hackathon/titan-technext-hackathon-2023/images/a32735b0ef-cover_1_1_1.jpg`} text={`https://media-fastly.hackerearth.com/media/hackathon/titan-technext-hackathon-2023/images/a32735b0ef-cover_1_1_1.jpg`} title={`Future Wear Techathon 2023`} />
